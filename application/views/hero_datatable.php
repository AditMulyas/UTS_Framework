		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<?php foreach ($hero_list as $key) { ?>
									<tr>
										...
										<td><?php echo $key->tanggal_lahir ?></td>
											<td><img src="<?=base_url()?>assets/uploads/<?=$key->foto ?>" width="100" height="100"></td>
										<td>
					...
					<div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
					 <center><a href="<?php echo site_url('hero/create') ?>"><button type="button" class="btn btn-danger">Tambah Hero</button></center>
					</div>
